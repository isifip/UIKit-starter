...
class RestaurantTableViewController: UITableViewController {
    ...
    var restaurants:[Restaurant] = [
        ...
        Restaurant(name: "Graham Avenue Meats", type: "Breakfast & Brunch", location: "445 Graham Ave Brooklyn, NY 11211", phone: "455-232345", description: "Classic Italian deli & butcher draws patrons with meat-filled submarine sandwiches. We use the freshest meats and veggies to create the perfect panini for you. We look forward to seeing you!", image: "Graham Avenue Meats", isFavorite: false),
    ...
    override func viewDidLoad() {
        ...
        // Customize the navigation bar appereance
        if let appearance = navigationController?.navigationBar.standardAppearance {
            ...
            if let customFont = UIFont(name: "Nunito-Bold", size: 45.0) {
                ...
                appearance.largeTitleTextAttributes = [
                    .foregroundColor: UIColor(named: "NavigationBarTitle")!, .font: customFont
                ]
            }
