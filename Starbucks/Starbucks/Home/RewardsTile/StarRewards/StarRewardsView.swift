...
class StarRewardsView: UIView {
    ...
    var rewards: [Reward] = [
        ...
        Reward(numberOfPoints: "50", description: "Brewed hot coffe, bakery item or hot"),
        ...
        Reward(numberOfPoints: "400", description: "Select merchandise or at-home coffe")
    ]
...
extension StarRewardsView {
    func style() {
        ...
        label.text = "Rewards your can get with Stars"
    }
    ...
    func layout() {
        ...
        for reward in rewards {
            stackView.addArrangedSubview(StarRewardsRow(numberOfPoints: reward.numberOfPoints,
